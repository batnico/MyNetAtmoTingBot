...
cred = {                           # You can hard code authentication information in the following lines
        "CLIENT_ID" :  "5ecfb67a0c926451d472775b",         #   Your client ID from Netatmo app registration at http://dev.netatmo.com/dev/listapps
        "CLIENT_SECRET" : "CyIFp7DcOtByQ3MufIpSBGjN8RRH2LcTM",      #   Your client app secret   '     '
        "USERNAME" : "nico@nicholas-etienne.com",           #   Your netatmo account username
        "PASSWORD" : "nicoetie"            #   Your netatmo account password
        }
